 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://SoapWebService/}weather" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetForecastResponse {
    ...
    protected List<Weather> _return;
     ...
     * 
     */
    public List<Weather> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Weather>();
        }
        return this._return;
    }
